        ...
        {q.options.map((opt, i) => {
          ...
          return (
            <button 
              ...
              className={`text-left p-6 rounded-[2rem] border-2 font-black transition-all text-lg flex items-center space-x-5 ${
                selectedAnswer === null ? 'bg-slate-50 border-slate-100 hover:border-blue-400 hover:bg-white' :
