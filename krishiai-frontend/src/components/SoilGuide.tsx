...
import { interpretSoilReportAI, generateSpeech, decodeBase64, decodeAudioData } from '../services/ai/geminiService';
...
const SoilGuide: React.FC<SoilGuideProps> = ({ onAction, onShowFeedback, onBack, onSaveReport }) => {
  ...
  const handleInterpret = async () => {
    ...
    try {
      const result: string | undefined = await interpretSoilReportAI(inputs);
