			...
			>
				{isShareOpen && (
					<ShareDialog
						...
						title={
							lang === "bn"
								? "কৃষি এআই: স্মার্ট কৃষি ইকোসিস্টেম"
								: "Krishi AI: Smart Agri Ecosystem"
						}
						content={
							lang === "bn"
								? "বাংলাদেশের কৃষকদের জন্য একটি সমন্বিত এআই ইকোসিস্টেম।"
